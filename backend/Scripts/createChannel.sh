...
setGlobalsForPeer0Org1(){
    ...
    export CORE_PEER_MSPCONFIGPATH=$GOPATH/src/github.com/Reflect/backend/hyperledger/crypto-config/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp
...
setGlobalsForPeer0Org2(){
    ...
    export CORE_PEER_MSPCONFIGPATH=$GOPATH/src/github.com/Reflect/backend/hyperledger/crypto-config/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp
